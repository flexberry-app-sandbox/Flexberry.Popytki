...
namespace IIS.Popytki
{
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Popytki.DetailArrayOfРекомендац fРекомендации;
        ...
        public virtual IIS.Popytki.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.Popytki.DetailArrayOfРекомендац(this);
                }
                IIS.Popytki.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.Popytki.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.Popytki.ПричинУвольн));
                }
            }
        }
    }
