...
namespace IIS.Popytki
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Popytki.ПричинУвольн fПричинУвольн;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Popytki.ПричинУвольн.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПричинУвольн"})]
        public virtual IIS.Popytki.ПричинУвольн ПричинУвольн
        {
            get
            {
                ...
                IIS.Popytki.ПричинУвольн result = this.fПричинУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.Popytki.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Popytki.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.Popytki.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.Popytki.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.Popytki.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.Popytki.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Popytki.Рекомендац dataobject)
        {
